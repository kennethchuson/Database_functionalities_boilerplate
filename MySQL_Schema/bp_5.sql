...
When if a user is an admin, the admin can able to create rooms. Room contains name and description. Non admin users can either want to join a room or not. 
...
To keep track of which user created a room, you could add a creator_id column that references the id column in the users table.
